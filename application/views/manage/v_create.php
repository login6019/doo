...
<section>
<article>
<form method="post" name="indexForm" action="/Process/createIndex">
	<table border="1" cellpadding="3" cellspacing="0" >
	<tr>
		<td>인덱스명</td>
		<td><input type="text" name="indexName" id="indexName" /></td>
	</tr>
	<tr>
		<td>타입명</td>
	...
	<tr>
		<td colspan= "2"><button type="submit" id="submit">인덱스 생성</button></td>
	</tr>
	</table>
</form>
</article>
